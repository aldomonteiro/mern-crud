...
A simple record system using MongoDB, Express.js, React.js, and Node.js with real-time Create, Read, Update, Delete and Search operations using Socket.io. REST API was implemented on the back-end. Semantic UI React was used for the UI.

It is based in the excelent
